        ...
        <table class="table-not-bootstrap">
            ...
            <tbody>
                @if(count($mesEquipes) > 0)
                    <tr class="separator">
                        <td colspan="7" class="text-center text-gray">My Teams</td>
                    </tr>
                @endif
                            ...
                            @if(count($equipe->joueur) > 0)
                                <div class="table-items">
                                    @foreach($equipe->joueur as $joueur)
                                        <span class="badge secondary">{{ $joueur->first_name }} {{ $joueur->last_name }}</span>
                                    @endforeach
                                </div>
                ...
                @empty
                    <tr>
                        <td colspan="7" class="table-empty">You have no teams yet</td>
                    </tr>
                @endforelse

                @if(count($mesEquipes) > 0)
                    <tr class="separator">
                        <td colspan="7" class="text-center text-gray">Other Teams</td>
                    </tr>
                @endif
                ...
                @empty
                    <tr>
                        <td colspan="7" class="table-empty">No other teams found</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
