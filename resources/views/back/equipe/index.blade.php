                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            @if($equipe->joueurs)
                                <div class="d-flex flex-wrap gap-1">
                                    @foreach($equipe->joueur as $joueur)
                                        <span class="badge bg-secondary small">{{ $joueur->first_name }} {{ $joueur->last_name }}</span>
                                    @endforeach
                                </div>
                        ...
                        <td>
                            <div class="btn-group" role="group">
                                ...
                                <form method="POST" action="{{ route('equipe.destroy', $equipe->id) }}" style="display: inline;" 
                    ...
                    <tr>
                        <td colspan="7" class="text-center text-muted py-4">
                            ...
                            <br>
                            <a href="{{ route('equipe.create') }}" class="btn btn-primary mt-2">Créer la première équipe</a>
                        </td>
                    </tr>
                    @endforelse
                </tbody>
