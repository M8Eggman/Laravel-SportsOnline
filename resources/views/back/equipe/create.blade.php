            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('back.equipe.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="name" class="form-label">Nom de l'équipe <span
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="genre_id" class="form-label">Genre <span
                                                class="text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('continent_id') is-invalid @enderror"
                                            id="continent_id" name="continent_id">
                                    ...
                                    <div class="mb-3">
                                        <label for="src" class="form-label">Continent</label>
                                        <input type="file" class="form-select @error('src') is-invalid @enderror" id="src" name="src"/>
                                        @error('src')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
